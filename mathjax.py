...
from secret import path_to_mathjax_js
...
class MathJaxRenderer(HTMLRenderer, LaTeXRenderer):
    ...
    then LaTeXRenderer.
    """
    path_to_mathjax_js = "https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.7/MathJax.js?config=TeX-MML-AM_CHTML" if not path_to_mathjax_js else path_to_mathjax_js
